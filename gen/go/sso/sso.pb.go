...
type PerformPasswordResetRequest struct {
	...
	Token       string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`             // Токен для сброса полученный пользователем по email
	NewPassword string `protobuf:"bytes,2,opt,name=newPassword,proto3" json:"newPassword,omitempty"` // Новый пароль пользователя
}
...
func (x *ValidateResponse) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
type PasswordResetResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // Сообщение об успехе или описание ошибки
}
...
type PerformPasswordResetResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PerformPasswordResetResponse) Reset() {
	*x = PerformPasswordResetResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PerformPasswordResetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PerformPasswordResetResponse) ProtoMessage() {}

func (x *PerformPasswordResetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PerformPasswordResetResponse.ProtoReflect.Descriptor instead.
func (*PerformPasswordResetResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{11}
}

func (x *PerformPasswordResetResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x34, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64,
	...
	0x52, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x58, 0x0a,
	...
	0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x57, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x0a, 0x1b, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	...
	,
	...
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0f, 0x56,
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x15,
	...
	0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a,
	...
	0x72, 0x65, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x14,
	...
	,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*PasswordResetRequest)(nil),         // 5: auth.PasswordResetRequest
	(*PerformPasswordResetRequest)(nil),  // 6: auth.PerformPasswordResetRequest
	...
	(*PerformPasswordResetResponse)(nil), // 11: auth.PerformPasswordResetResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0,  // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	4,  // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	2,  // 2: auth.Auth.ValidateSession:input_type -> auth.ValidateRequest
	3,  // 3: auth.Auth.RefreshSession:input_type -> auth.RefreshRequest
	5,  // 4: auth.Auth.RequestPasswordReset:input_type -> auth.PasswordResetRequest
	6,  // 5: auth.Auth.PerformPasswordReset:input_type -> auth.PerformPasswordResetRequest
	1,  // 6: auth.Auth.Register:output_type -> auth.RegisterResponse
	7,  // 7: auth.Auth.Login:output_type -> auth.LoginResponse
	8,  // 8: auth.Auth.ValidateSession:output_type -> auth.ValidateResponse
	9,  // 9: auth.Auth.RefreshSession:output_type -> auth.RefreshResponse
	10, // 10: auth.Auth.RequestPasswordReset:output_type -> auth.PasswordResetResponse
	11, // 11: auth.Auth.PerformPasswordReset:output_type -> auth.PerformPasswordResetResponse
...
func file_sso_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sso_sso_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PerformPasswordResetRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sso_sso_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PerformPasswordResetResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
